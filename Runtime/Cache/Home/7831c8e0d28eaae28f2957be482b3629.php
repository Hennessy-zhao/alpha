...
<head>
	...
	<link rel="stylesheet" href="/alpha/Public/Outward/user/css/register.css">
	...
	<div class="row" style="padding:0px;">
					...
					<div class="col-md-12" id="content">
						<div class="column">
							...
							<div class="col-md-12" id="message">
								<form autocomplete="off" id="form1" action="#" method="post">
									<div class="row">
	 ...
	 $(function(){
	 	$("#username").blur(function(){
    			...
    			{
    				 $.post("<?php echo U('Home/User/repeatusername','','');?>",{
				          user : $("#username").val()
				      },function(data){
				        if (data==1) {
	 	...
	 	$("#truename").blur(function(){
	 				$.post("<?php echo U('Home/User/repeattruename','','');?>",{
				          user : $("#truename").val()
				      },function(data){
				        if (data==1) {
	 	...
	 	$("#form1").submit(function(){
	 		...
	 		if (username!=''&&truename!=''&&password!=''&&password2!=''&&email!=''&&start_year!=0) {
	 			if (p_username==''&&p_truename==''&&p_password2==''&&p_email==''&&p_phone=='') {
	 				$.post("<?php echo U('Home/User/doregister','','');?>",{
				          username : username,
				          truename : truename,
				          password : password,
				          email : email,
